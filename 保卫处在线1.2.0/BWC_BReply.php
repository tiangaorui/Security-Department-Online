...
<div class="contact">
    <div class="container">
		...
		<div id="image" style="width: 280px; float: right"><img src="images/1.jpg" width="270px" onclick="javascript:window.open(this.src)" style="cursor: pointer">这里是图片</div>
            </div>
        </div>
        <div class="w3_contact_grids">
            <form action="BWC_Reply.php" method="post">
                <script type="text/javascript">
                    <!--
                ...
                <span class="input input--jiro">
						<input class="input__field input__field--jiro" type="text" id="input-10" name="BName" placeholder="你的名字" required="">
                ...
                <span class="input input--jiro">
						<input class="input__field input__field--jiro" type="text" id="input-12" name="BPhone_Number" placeholder="你的联系方式" required="">
						<label class="input__label input__label--jiro" for="input-12">
							<span class="input__label-content input__label-content--jiro">联系方式</span>
						</label>
					</span>
                <textarea name="BMessage" placeholder="在这里输入你的求助内容..." required=""></textarea>
		...
		<nav style="float: right">
					<ul class="pagination pagination-lg">
						<li><a href="#" aria-label="Next"><span aria-hidden="true">下一个</span></a></li>
					</ul>
				</nav>
        </div>
    </div>
